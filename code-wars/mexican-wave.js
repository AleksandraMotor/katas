...
// is an example of metachronal rhythm achieved in a packed stadium when successive groups of spectators briefly stand, yell, 
...
function wave(str){
    ...
    for (let i = 0; i < str.length; i++) {
      ...
      if (letter === " ") {
        ...
        mexicanWave.push(str.slice(0, i) + letter.toUpperCase() + str.slice(i+1)); 
      };
    };
    return mexicanWave;
};